...
use Vuleticd\OrderHistory\Api\Data\OrderInterface;
use Magento\Framework\DataObject\IdentityInterface;

class Order  extends \Magento\Framework\Model\AbstractModel implements OrderInterface, IdentityInterface
{
	const CACHE_TAG = 'sales_history_order';

    /**
     * @var string
     */
    protected $_cacheTag = 'sales_history_order';
    ...
    {
        $this->_init('Vuleticd\OrderHistory\Model\ResourceModel\Order');
    }
    ...
    {
        return [self::CACHE_TAG . '_' . $this->getOrderId()];
    }
